...
typedef struct cmdLine {
  ...
  int idx;
  /* index of current command in the chain of cmdLines (0 for the first) */
  struct cmdLine * next;
...
/* When successful, returns a pointer to cmdLine (in case of a pipe, this will be the head of
a linked list) */
